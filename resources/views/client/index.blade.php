...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="frontend/images/logo/favicon.png" type="image/x-icon">

    <!-- CSS Files -->
    <link rel="stylesheet" href="frontend/css/animate-3.7.0.css">
    <link rel="stylesheet" href="frontend/css/font-awesome-4.7.0.min.css">
    <link rel="stylesheet" href="frontend/css/bootstrap-4.1.3.min.css">
    <link rel="stylesheet" href="frontend/css/owl-carousel.min.css">
    <link rel="stylesheet" href="frontend/css/jquery.datetimepicker.min.css">
...
<body>
            ...
            <div class="container">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li><a href="{{URL:: to('/logindoc')}}">Doctor's</a></li>
	...
	<script src="frontend/js/vendor/bootstrap-4.1.3.min.js"></script>
    <script src="frontend/js/vendor/wow.min.js"></script>
    <script src="frontend/js/vendor/owl-carousel.min.js"></script>
    <script src="frontend/js/vendor/jquery.datetimepicker.full.min.js"></script>
    <script src="frontend/js/vendor/jquery.nice-select.min.js"></script>
    <script src="frontend/js/vendor/superfish.min.js"></script>
