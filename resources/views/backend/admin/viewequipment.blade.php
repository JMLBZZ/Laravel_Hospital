                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Equipment #052367981 Details</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Equipment Name : Surgical Robot</h2>
                                        <hr>
                                        <h4 class="text-danger">Equipment Vendor: Nexus</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment Barcode: 052367981</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment(s) Available : 100</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment Status : Functioning</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment Description</h4>
                                        <p class="text-muted mb-4">
                                        <p>Surgical Robots aid in surgey process.</p>
                                        </p>
                                        <!--
