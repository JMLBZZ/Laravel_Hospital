                                ...
                                <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="his_admin_view_single_pharm_category.php?pharm_cat_id=2"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="his_admin_view_single_pharm_category.php?pharm_cat_id=1"
                                                    class="badge badge-success"><i class="mdi mdi-eye"></i> View</a></td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Antibiotics</td>
                                            <td>Cosmos Kenya Limited</td>
                                            <td><a href="his_admin_view_single_pharm_category.php?pharm_cat_id=3"
                                                    class="badge badge-success"><i class="mdi mdi-eye"></i> View</a></td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
