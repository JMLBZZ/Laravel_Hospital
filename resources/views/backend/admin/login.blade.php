...
<head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="backend/admin/images/favicon.ico">

        <!-- App css -->
        <link href="backend/admin/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="backend/admin/css/icons.min.css" rel="stylesheet" type="text/css" />
        <link href="backend/admin/css/app.min.css" rel="stylesheet" type="text/css" />
        <!--Load Sweet Alert Javascript-->
        
        <script src="backend/admin/js/swal.js"></script>
        <!--Inject SWAL-->
    ...
    <body class="authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="backend/admin/images/logo-dark.png" alt="" height="22"></span>
                                    </a>
        ...
        <footer class="footer footer-alt">
            2023 &copy; Jamel Bouazza</a> 
        </footer>
        
        <!-- Vendor js -->
        <script src="backend/admin/js/vendor.min.js"></script>

        <!-- App js -->
        <script src="backend/admin/js/app.min.js"></script>
