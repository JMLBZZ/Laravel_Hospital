                                ...
                                <form method="post">
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" required="required" value="TestTubes" name="eqp_name"
                                                class="form-control" id="inputEmail4">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Equipment Vendor</label>
                                            <input required="required" type="text" value="Casio" name="eqp_vendor"
                                                class="form-control" id="inputPassword4">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Equipment Quantity </label>
                                            <input required="required" type="text" value = "700000" name="eqp_qty"
                                                class="form-control" id="inputPassword4">
                                        </div>
                                        <div class="form-group col-md-4" style="display:none">
                                            <label for="inputPassword4" class="col-form-label">Equipment Department</label>
                                            <input required="required" type="text" value="Laboratory" name="eqp_dept"
                                                class="form-control" id="inputPassword4">
                                        </div>
                                        <div class="form-group col-md-6" style="display:none">
                                            <label for="inputPassword4" class="col-form-label">Equipment Status</label>
                                            <input required="required" type="text" value="Functioning" name="eqp_status"
                                                class="form-control" id="inputPassword4">
                                        </div>
                                    ...
                                    <div class="form-group" style="style:display-none">
                                        <label for="inputAddress" class="col-form-label">Pharmaceutical Category
                                            Description</label>
                                        <textarea required="required" type="text" class="form-control" name="eqp_desc" id="editor"><p>Testtubes are used to perform lab tests--</p></textarea>
                                    </div>

                                    <button type="submit" name="update_equipments" class="ladda-button btn btn-success"
                                        data-style="expand-right">Update Equipment</button>
