                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Patient's Name : John Doe</h2>
                                        <hr>
                                        <h3 class="text-danger ">Patient Number : RAV6C</h3>
                                        <hr>
                                        <h3 class="text-danger ">Patient Ailment : Malaria</h3>
                                        <hr>
                                        <h3 class="text-danger ">Date Recorded : 13/01/2020 - 01:01:48</h3>
                                        <hr>
                                        <h2 class="align-centre">Laboratory Test</h2>
                                        <hr>
                                        <p class="text-muted mb-4">
                                        <p><strong>Pain areas: </strong>in the abdomen or muscles</p>
                                        <p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or
                                            sweating</p>
                                        <p><strong>Gastrointestinal: </strong>diarrhoea, nausea, or vomiting</p>
                                        <p><strong>Also common: </strong>fast heart rate, headache, mental confusion, or
                                            pallor</p>
                                        </p>
                                        <hr>
                                        <h2 class="align-centre">Laboratory Result</h2>
                                        <p class="text-muted mb-4">
                                        <p><strong>Pain areas: </strong>in the abdomen or muscles -Tested Positive</p>
                                        <p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or
                                            sweating - Tested Positive</p>
                                        <p><strong>Gastrointestinal: </strong>diarrhoea, nausea, or vomiting - Tested
                                            Positive</p>
                                        <p>&nbsp;</p>
                                        </p>
                                        <hr>
