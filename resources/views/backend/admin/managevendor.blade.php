                                ...
                                <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>6ISKC</td>
                                            <td>info@cosmospharmaceuticallimited.com</td>


                                            <td>
                                                <a href="his_admin_view_single_vendor.php?v_number=6ISKC"
                                                    class="badge badge-success"><i class="fas fa-eye"></i> View</a>
                                                <a href="his_admin_update_single_vendor.php?v_number=6ISKC"
                                                    class="badge badge-success"><i class="fas fa-edit"></i> Update</a>
                                                <a href="his_admin_manage_vendor.php?delete_vendor_number=6ISKC"
