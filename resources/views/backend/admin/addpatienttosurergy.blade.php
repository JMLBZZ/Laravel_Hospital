                                ...
                                <form method="post">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" readonly required="required" value="Christine Moore"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input readonly required="required" type="text" value="Demo Test"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input readonly type="text" required="required" value="P4MLA"
