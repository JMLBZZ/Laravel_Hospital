                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Name : Lawrence Bischof</h2>
                                        <hr>
                                        <h3 class="text-danger">Age : 32 Years</h3>
                                        <hr>
                                        <h3 class="text-danger ">Patient Number : ISL1E</h3>
                                        <hr>
                                        <h3 class="text-danger ">Patient Ailment : Demo Test</h3>
                                        <hr>
                                        <h3 class="text-danger ">Date Recorded : 20/10/2022 - 06:10:15</h3>
                                        <hr>
