                                ...
                                <form method="post">
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" required="required" name="eqp_name" class="form-control"
                                                id="inputEmail4">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Equipment Vendor</label>
                                            <input required="required" type="text" name="eqp_vendor" class="form-control"
                                                id="inputPassword4">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Equipment Quantity </label>
                                            <input required="required" type="text" name="eqp_qty" class="form-control"
                                                id="inputPassword4">
                                        </div>
                                        <div class="form-group col-md-4" style="display:none">
                                            <label for="inputPassword4" class="col-form-label">Equipment Department</label>
                                            <input required="required" type="text" value="Surgical | Theatre"
                                                name="eqp_dept" class="form-control" id="inputPassword4">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required="required" readonly type="text" value="536874129" name="eqp_code"
                                            class="form-control" id="inputPassword4">
                                    </div>
                                    ...
                                    <button type="submit" name="add_equipments" class="ladda-button btn btn-success"
                                        data-style="expand-right">Add Equipment</button>
