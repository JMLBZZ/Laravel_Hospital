                                ...
                                <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="his_admin_view_single_payable_account.php?acc_number=620157843"
                                                    class="badge badge-success"><i class="fas fa-eye "></i> View</a>
                                                <a href="his_admin_update_single_payable_account.php?acc_number=620157843"
                                                    class="badge badge-warning"><i class="fas fa-clipboard-check "></i>
                                                    Update</a>
                                                <a href="his_admin_manage_acc_payable.php?delete_account=620157843"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="his_admin_view_single_payable_account.php?acc_number=518703294"
                                                    class="badge badge-success"><i class="fas fa-eye "></i> View</a>
                                                <a href="his_admin_update_single_payable_account.php?acc_number=518703294"
                                                    class="badge badge-warning"><i class="fas fa-clipboard-check "></i>
                                                    Update</a>
                                                <a href="his_admin_manage_acc_payable.php?delete_account=518703294"
                                                    class="badge badge-danger"><i class="fas fa-trash-alt "></i> Delete</a>
