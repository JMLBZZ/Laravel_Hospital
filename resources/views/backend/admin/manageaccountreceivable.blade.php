...
@section('title')
    Admin - Manage Account Receivable -
@endsection
                                ...
                                <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="his_admin_view_single_payable_account.php?acc_number=753680912"
                                                    class="badge badge-success"><i class="fas fa-eye "></i> View</a>
                                                <a href="his_admin_update_single_receivable_account.php?acc_number=753680912"
                                                    class="badge badge-warning"><i class="fas fa-clipboard-check "></i>
                                                    Update</a>
                                                <a href="his_admin_manage_acc_receivable.php?delete_account=753680912"
