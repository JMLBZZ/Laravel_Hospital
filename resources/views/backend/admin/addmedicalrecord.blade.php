                                ...
                                <form method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input required="required" type="text" readonly name="mdr_pat_age"
                                                value="30" class="form-control" id="inputPassword4"
                                                placeholder="Patient`s Last Name">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Patient Address</label>
                                            <input required="required" type="text" readonly name="mdr_pat_adr"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required="required" type="text" readonly name="mdr_pat_ailment"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2" style="display:none">
                                            ...
                                            <input type="text" name="mdr_number" value="VPFTK" class="form-control"
                                                id="inputZip">
                                        </div>
                                    </div>

                                    <button type="submit" name="add_patient_mdr" class="ladda-button btn btn-primary"
                                        data-style="expand-right">Add Patient Medical Record</button>
