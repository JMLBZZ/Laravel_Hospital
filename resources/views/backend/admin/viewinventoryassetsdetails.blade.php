...
@section('title')
    Admin - View Inventory Assets Details -
@endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Equipment #178640239 Details</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <div class="row">
                                <div class="col-xl-5">
                                    ...
                                    <div class="tab-content pt-0">
                                        ...
                                        <div class="tab-pane active show" id="product-1-item">
                                            <img src="assets/images/hosp_asset.jpg" alt=""
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Equipment Name : TestTubes</h2>
                                        <hr>
                                        <h4 class="text-danger">Equipment Vendor: Casio</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment Barcode: 178640239</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment(s) Available : 700000</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment Status : Functioning</h4>
                                        <hr>
                                        <h4 class="text-danger">Equipment Description</h4>
                                        <p class="text-muted mb-4">
                                        <p>Testtubes are used to perform lab tests--</p>
                                        </p>
                                        <!--
