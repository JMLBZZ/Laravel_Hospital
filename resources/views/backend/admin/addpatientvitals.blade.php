                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Capture Christine Moore Vitals</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                ...
                                <form method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required="required" readonly name=""
                                                value="Christine Moore" class="form-control" id="inputEmail4"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" required="required" readonly name="vit_pat_number"
                                                value="P4MLA" class="form-control" id="inputEmail4"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2" style="display:none">
                                            ...
                                            <input type="text" name="vit_number" value="48KJA" class="form-control"
                                                id="inputZip">
                                        </div>
                                    </div>
