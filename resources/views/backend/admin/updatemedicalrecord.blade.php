                                ...
                                <form method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" required="required" readonly name="mdr_pat_name"
                                                value="John Doe" class="form-control" id="inputEmail4"
                                                placeholder="Patient's Name">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Patient Age</label>
                                            <input required="required" type="text" name="mdr_pat_age" value="35"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input required="required" type="text" name="mdr_pat_adr"
                                                value="12 900 Los Angeles" class="form-control" id="inputPassword4"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required="required" readonly name="mdr_pat_number"
                                                value="RAV6C" class="form-control" id="inputEmail4"
                                                placeholder="DD/MM/YYYY">
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4" class="col-form-label">Patient Ailment</label>
                                            <input required="required" type="text" name="mdr_pat_ailment" value="Malaria"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2" style="display:none">
                                            ...
                                            <input type="text" name="mdr_number" value="8GOHZ" class="form-control"
                                                id="inputZip">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea required="required" type="text" class="form-control" name="mdr_pat_prescr" id="editor"><ul><li>Combination of atovaquone and proguanil (Malarone)</li><li>Quinine sulfate (Qualaquin) with doxycycline (Vibramycin, Monodox, others)</li><li>Mefloquine.</li><li>Primaquine phosphate.</li></ul> </textarea>
                                    </div>
