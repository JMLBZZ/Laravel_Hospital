                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required="required" type="text" readonly name="pres_pat_age"
                                                value="42" class="form-control" id="inputPassword4"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input required="required" type="text" readonly name="pres_pat_addr"
                                                value="28 Holly Street" class="form-control" id="inputPassword4"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input required="required" readonly type="text" name="pres_pat_type"
                                                value="InPatient" class="form-control" id="inputPassword4"
                                                placeholder="Patient`s Age">
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input required="required" type="text" value="Test Test" name="pres_pat_ailment"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2" style="display:none">
                                            ...
                                            <input type="text" name="pres_number" value="R3KLV" class="form-control"
                                                id="inputZip">
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" name="add_patient_presc" class="ladda-button btn btn-primary"
