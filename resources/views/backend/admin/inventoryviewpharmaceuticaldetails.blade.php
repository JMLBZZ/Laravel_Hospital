...
@section('title')
    Admin - Inventory View Pharmaceutical Details -
@endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">#465931288 - Test Pharma</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Pharmaceutical Name : Test Pharma</h2>
                                        <hr>
                                        <h4 class="text-danger">Pharmaceutical Vendor : Cosmos Pharmaceutical Limited</h4>
                                        <hr>
                                        <h4 class="text-danger">Pharmaceutical Quantity : 36 Cartons</h4>
                                        <hr>
                                        <h4 class="text-danger">Pharmaceutical Description</h4>

                                        <p class="text-muted mb-4">
                                        <p>This is a demo test.&nbsp;This is a demo test.&nbsp;This is a demo test.</p>
                                        </p>
                                        <!--
