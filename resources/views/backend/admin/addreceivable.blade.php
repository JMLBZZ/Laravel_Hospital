                                ...
                                <form method="post">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required="required" name="acc_name" class="form-control"
                                                id="inputEmail4">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4" class="col-form-label">Account Amount($)</label>
                                            <input type="text" required="required" name="acc_amount" class="form-control"
                                                id="inputEmail4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" style="display:none">
                                        ...
                                        <input type="text" name="acc_number" value="470358629" class="form-control"
                                            id="inputZip">
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <input required="required" value="Receivable Account" type="text"
                                            class="form-control" name="acc_type" id="inputAddress">
                                    </div>

                                    <button type="submit" name="add_acc" class="ladda-button btn btn-success"
                                        data-style="expand-right">Add Account</button>
