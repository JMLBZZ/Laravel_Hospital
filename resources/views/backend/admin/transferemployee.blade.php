                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required="required" type="email" readonly value="BKTWQ"
                                            class="form-control" name="doc_email" id="inputAddress">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputAddress" class="col-form-label">Employee Current Working Department
                                        </label>
                                        <input required="required" type="email" readonly value="Laboratory"
                                            class="form-control" name="doc_email" id="inputAddress">
                                    </div>
                                    ...
                                    <button type="submit" name="trans_dept" class="ladda-button btn btn-success"
                                        data-style="expand-right">Transfer Employee</button>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="inputAddress" class="col-form-label">Employee Number</label>
                                        <input required="required" type="email" readonly value="YDS7L"
                                            class="form-control" name="doc_email" id="inputAddress">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputAddress" class="col-form-label">Employee Current Working
                                            Department </label>
                                        <input required="required" type="email" readonly value="Surgery | Theatre"
                                            class="form-control" name="doc_email" id="inputAddress">
                                    </div>
