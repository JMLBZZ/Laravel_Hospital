                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!--Add Patient Form-->
                                <form id="formpatient" 
                                    action="{{ route('editpatient', $patient->id) }}" 
                                    method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required="required" name="patient_name"
                                                class="form-control" id="inputEmail4" placeholder="Patient's Name" value="{{$patient->patient_name}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4" class="col-form-label">Patient Address</label>
                                            <input type="text" required="required" name="patient_address"
                                                class="form-control" id="inputEmail4" placeholder="Patient's Address" value="{{$patient->patient_address}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required="required" name="patient_number"
                                                class="form-control" id="inputEmail4" placeholder="Patient's Number" value="{{$patient->patient_number}}">
                                        </div>
                                        <div class="form-group col-md-6">
