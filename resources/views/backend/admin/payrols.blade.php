                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="his_admin_view_single_employee.php?doc_id=6&&doc_number=YDS7L"
                                                    class="badge badge-primary"><i class="mdi mdi-eye"></i> View</a>
                                                <a href="his_admin_add_single_employee_payroll.php?doc_number=YDS7L"
                                                    class="badge badge-success"><i class="fas fa-eye-dropper "></i> Add
                                                    Payroll</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="his_admin_view_single_employee.php?doc_id=5&&doc_number=BKTWQ"
                                                    class="badge badge-primary"><i class="mdi mdi-eye"></i> View</a>
                                                <a href="his_admin_add_single_employee_payroll.php?doc_number=BKTWQ"
                                                    class="badge badge-success"><i class="fas fa-eye-dropper "></i> Add
                                                    Payroll</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="his_admin_view_single_employee.php?doc_id=12&&doc_number=5VIFT"
                                                    class="badge badge-primary"><i class="mdi mdi-eye"></i> View</a>
                                                <a href="his_admin_add_single_employee_payroll.php?doc_number=5VIFT"
                                                    class="badge badge-success"><i class="fas fa-eye-dropper "></i> Add
                                                    Payroll</a>
