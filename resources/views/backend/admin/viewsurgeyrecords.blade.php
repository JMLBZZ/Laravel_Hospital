                            ...
                            <div class="row">
                                <div class="col-xl-5">
                                    ...
                                    <div class="tab-content pt-0">
                                        ...
                                        <div class="tab-pane active show" id="product-1-item">
                                            <img src="assets/images/surg.png" alt=""
                                ...
                                <div class="col-xl-7">
                                    ...
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Patient's Name : Christine Moore</h2>
                                        <hr>
                                        <h3 class="align-centre ">Patient Number : 4TLG0</h3>
                                        <hr>
                                        <h3 class="align-centre ">Patient Ailment : Demo Test</h3>
                                        <hr>
                                        <h3 class="align-centre ">Date Surgery Conducted : 22/10/2022</h3>
                                        <hr>
                                        <h2 class="align-centre">Surgeon : Bryan Arreola </h2>
                                        <hr>
                                        <h2 class="align-centre">Surgery Status : <span class ="btn btn-success">
                                                Successful</span> </h2>
                                        <hr>
