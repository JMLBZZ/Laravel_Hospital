...
@section('title')
    Admin - Manage Pharmacy Category Details -
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Pharmaceutical Name: Antibiotics</h2>
                                        <hr>
                                        <h6 class="text-danger">Phrmaceutical VendorCosmos Kenya Limited</h6>
                                        <hr>
