                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Capture Lawrence Bischof Vitals</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                ...
                                <form method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required="required" readonly name=""
                                                value="Lawrence Bischof" class="form-control" id="inputEmail4"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" required="required" readonly name="vit_pat_number"
                                                value="ISL1E" class="form-control" id="inputEmail4"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2" style="display:none">
                                            ...
                                            <input type="text" name="vit_number" value="TJCOU" class="form-control"
                                                id="inputZip">
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" name="add_patient_vitals" class="ladda-button btn btn-success"
