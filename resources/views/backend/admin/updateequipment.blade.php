                                ...
                                <form method="post">
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" required="required" value="Surgical Robot" name="eqp_name"
                                                class="form-control" id="inputEmail4">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Equipment Vendor</label>
                                            <input required="required" type="text" value="Nexus" name="eqp_vendor"
                                                class="form-control" id="inputPassword4">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Equipment Quantity </label>
                                            <input required="required" type="text" value = "100" name="eqp_qty"
                                                class="form-control" id="inputPassword4">
                                        </div>
                                    ...
                                    <div class="form-group" style="style:display-none">
                                        <label for="inputAddress" class="col-form-label">Pharmaceutical Category
                                            Description</label>
                                        <textarea required="required" type="text" class="form-control" name="eqp_desc" id="editor"><p>Surgical Robots aid in surgey process.</p></textarea>
                                    </div>
