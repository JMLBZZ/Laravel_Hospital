...
@section('title')
    Admin - Add Surgery Patient Details -
@endsection
                                ...
                                <form method="post">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" readonly required="required" value="Helen Macdougall"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input readonly required="required" type="text" value="Test Test"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input readonly type="text" required="required" value="K74P3"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2" style="display:none">
                                            ...
                                            <input type="text" name="s_number" value="TR2V9" class="form-control"
                                                id="inputZip">
                                        </div>
                                    </div>
