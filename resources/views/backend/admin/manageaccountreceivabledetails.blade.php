...
@section('title')
    Admin - Manage Account Receivable Details -
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Account Number : 753680912</h2>
                                        <hr>
                                        <h4 class="text-danger"> Account Name : Equity Bank</h6>
                                            <hr>
                                            <h4 class="text-danger">Account Amount : $ 12566 </h6>
                                                <hr>
                                                <h4 class="align-centre">Account Description</h6>
                                                    <hr>
                                                    <p class="text-muted mb-4">
                                                    <p>Find <em>bank account</em> stock <em>images</em> in HD and millions
                                                        of other royalty-free stock photos, illustrations and vectors in the
                                                        Shutterstock collection. Thousands of new</p>
                                                    </p>
                                                    <!--
