...
@section('title')
    Admin - View Medical Record Details -
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="pl-xl-3 mt-3 mt-xl-0">
                                        <h2 class="mb-3">Name : Cynthia Connolly</h2>
                                        <hr>
                                        <h3 class="text-danger">Age : 22 Years</h3>
                                        <hr>
                                        <h3 class="text-danger ">Patient Number : 3Z14K</h3>
                                        <hr>
                                        <h3 class="text-danger ">Patient Ailment : Demo Test</h3>
                                        <hr>
                                        <h3 class="text-danger ">Date Recorded : 18/10/2022 - 06:10:46</h3>
                                        <hr>
